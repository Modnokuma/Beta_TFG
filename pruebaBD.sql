...
--
GRANT USAGE ON * . * TO `IU2020-test`@`localhost`;
DROP USER `dani`@`localhost`;
...
CREATE TABLE `usuario` (
  ...
  `organizacion_usuario` varchar(45) COLLATE utf8_bin NOT NULL,
  `puesto_usuario` varchar(45) COLLATE utf8_bin NOT NULL,
  `direccion_usuario` varchar(200) COLLATE utf8_bin NOT NULL,
  `correo_usuario` varchar(45) COLLATE utf8_bin NOT NULL
...
CREATE TABLE `proyecto` (
  ...
  `nombre_proyecto` varchar(48) COLLATE utf8_bin NOT NULL,
  `descripcion_proyecto` varchar(200) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
DROP TABLE IF EXISTS `metadato_proyecto`;
CREATE TABLE `metadato_proyecto` (
  `id_metadato_proyecto` int(11) NOT NULL,
  `nombre_metadato_proyecto` varchar(48) COLLATE utf8_bin NOT NULL,
  `descripcion_metadato_proyecto` varchar(200) COLLATE utf8_bin NOT NULL,
  `tipo_metadato_proyecto` varchar(48) COLLATE utf8_bin NOT NULL,
  `id_proyecto` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `tipo_observacion` (
  ...
  `nombre_tipo_observacion` varchar(48) COLLATE utf8_bin NOT NULL,
  `descripcion_tipo_observacion` varchar(200) COLLATE utf8_bin NOT NULL,
  `id_proyecto` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
DROP TABLE IF EXISTS `propiedad_observacion`;
CREATE TABLE `propiedad_observacion` (
  `id_propiedad_observacion` int(11) NOT NULL,
  `id_tipo_observacion` int(11) NOT NULL,
  `nombre_propiedad_observacion` varchar(48) COLLATE utf8_bin NOT NULL,
  `descripcion_propiedad_observacion` varchar(200) COLLATE utf8_bin NOT NULL,
  `tipo_propiedad_observacion` varchar(48) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `parametro` (
  ...
  `nombre_parametro` varchar(45) COLLATE utf8_bin NOT NULL,
  `descripcion_parametro` varchar(200) COLLATE utf8_bin NOT NULL,
  `tipo_parametro` varchar(45) COLLATE utf8_bin NOT NULL,
  `formato_parametro` varchar(45) COLLATE utf8_bin,
  `rango_desde_parametro` varchar(45) COLLATE utf8_bin,
  `rango_hasta_parametro` varchar(45) COLLATE utf8_bin 
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `unidad` (
  ...
  `nombre_unidad` varchar(45) COLLATE utf8_bin NOT NULL,
  `descripcion_unidad` varchar(200) COLLATE utf8_bin NOT NULL,
  `id_parametro` int(11) NOT NULL 
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `observacion` (
  ...
  `nombre_observacion` varchar(45) COLLATE utf8_bin NOT NULL,
  `descripcion_observacion` varchar(200) COLLATE utf8_bin NOT NULL,
  `fecha_observacion` date NOT NULL,
  `responsable_observacion` varchar(45) COLLATE utf8_bin NOT NULL,
...
(1, 'Observacion 1', 'observacion...','01-01-2024','Alguien1',1, 1),
(2, 'Observacion 2', 'observacion...','02-02-2024','Alguien2',1, 2),
(3, 'Observacion 3', 'observacion..','30-12-2023','alguien3',1, 3),
(4, 'Observacion 4', 'observacion...','5-02-2024','Alguien4',1, 4);
...
DROP TABLE IF EXISTS `item_observacion`;
...
DROP TABLE IF EXISTS `parametro_obtenido`;
...
CREATE TABLE `usuario_proyecto` (
  `id_proyecto` int(11) NOT NULL,
  `id_usuario` int(11) NOT NULL,
  `rol_usuario_proyecto` varchar(45) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
DROP TABLE IF EXISTS `proyecto_parametro`;
